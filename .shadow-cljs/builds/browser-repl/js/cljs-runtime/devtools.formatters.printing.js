...
var len__4736__auto___38353 = arguments.length;
var i__4737__auto___38354 = (0);
while(true){
if((i__4737__auto___38354 < len__4736__auto___38353)){
args__4742__auto__.push((arguments[i__4737__auto___38354]));

var G__38355 = (i__4737__auto___38354 + (1));
i__4737__auto___38354 = G__38355;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38117){
var G__38118 = cljs.core.first(seq38117);
var seq38117__$1 = cljs.core.next(seq38117);
var G__38119 = cljs.core.first(seq38117__$1);
var seq38117__$2 = cljs.core.next(seq38117__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38118,G__38119,seq38117__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38199_SHARP_){
return (!((cljs.core.meta(p1__38199_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38228__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e38283){var _e__26390__auto__ = e38283;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e38289){var _e__26390__auto__ = e38289;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__38304 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__38305 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__38305);

try{var map__38309 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38309__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__38304);
}});
...
var temp__5733__auto___38391 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___38391)){
var managed_print_level_38392 = temp__5733__auto___38391;
var _STAR_print_level_STAR__orig_val__38341_38393 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__38342_38394 = managed_print_level_38392;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__38342_38394);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__38326_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__38326_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__38341_38393);
}} else {
job_fn();
}
