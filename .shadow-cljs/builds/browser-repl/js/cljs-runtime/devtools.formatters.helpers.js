...
var G__37971 = devtools.prefs.pref(v);
v = G__37971;
continue;
} else {
return v;
...
}catch (e37907){var _e__26390__auto__ = e37907;
return false;
}})();
...
}catch (e37915){var _e__26390__auto__ = e37915;
return false;
}})();
...
}catch (e37918){var _e__26390__auto__ = e37918;
return false;
}}
}
});
...
var vec__37942 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37942,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37942,(1),null);
...
return cljs.core.some((function (p1__37949_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37949_SHARP_);
}),template);
});
