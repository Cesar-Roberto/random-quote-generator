...
var o37626 = temp__5733__auto__;
var temp__5733__auto____$1 = (o37626["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o37627 = temp__5733__auto____$1;
return (o37627["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26383__auto__ = f;
return (o__26383__auto__["toString"]).call(o__26383__auto__);
} else {
return "";
}
...
try{var o__26383__auto___37912 = t;
(o__26383__auto___37912["cljs$lang$ctorPrWriter"]).call(o__26383__auto___37912,t,writer);
}catch (e37657){var __37923 = e37657;
}
...
var char_code = (function (){var o__26383__auto__ = (new String(char$));
return (o__26383__auto__["charCodeAt"]).call(o__26383__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26383__auto__ = String;
return (o__26383__auto__["fromCharCode"]).call(o__26383__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37666 = num_code;
switch (G__37666) {
case (1):
return (185);
...
var o__26383__auto__ = String;
return (o__26383__auto__["fromCharCode"]).call(o__26383__auto__,superscript_code);
});
/**
...
}catch (e37672){var _e__26390__auto__ = e37672;
return false;
}})())){
...
var vec__37673 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37673,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o37682 = temp__5733__auto__;
var temp__5733__auto____$1 = (o37682["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o37683 = temp__5733__auto____$1;
return (o37683["nameToPath"]);
} else {
return null;
}
} else {
...
var G__37934 = (i__4737__auto___37931 + (1));
i__4737__auto___37931 = G__37934;
continue;
} else {
}
break;
...
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37709,(0),null);
...
var G__37936 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__37937 = cljs.core.butlast(remaining_tokens);
name_tokens = G__37936;
remaining_tokens = G__37937;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37684){
var G__37685 = cljs.core.first(seq37684);
var seq37684__$1 = cljs.core.next(seq37684);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37685,seq37684__$1);
}));
...
var vec__37722 = cljs.core.split_with((function (p1__37721_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37721_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37722,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37722,(1),null);
...
var vec__37737 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37737,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37737,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__37945 = cljs.core.rest(remaining_tokens);
var G__37946 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__37945;
name_tokens = G__37946;
continue;
} else {
...
var vec__37742 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37742,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37742,(1),null);
var vec__37745 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37745,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37745,(1),null);
var vec__37748 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37748,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37748,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37748,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37748,(3),null);
...
var vec__37797 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37797,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37797,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37797,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37797,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37797,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37797,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__37801 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37801,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37801,(1),null);
var vec__37804 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37804,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37804,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__37811 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__37811) : devtools.munging.parse_fn_info_deep.call(null,G__37811));
})()));
}
} else {
return fn_info;
...
var G__37955 = (arity + (1));
var G__37956 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37826){
var vec__37827 = p__37826;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37827,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37827,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37839_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__37839_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37840_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__37840_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37845){
var vec__37846 = p__37845;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37846,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37841){
var G__37842 = cljs.core.first(seq37841);
var seq37841__$1 = cljs.core.next(seq37841);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37842,seq37841__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37855__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37855__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37855__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37855__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37856 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37856,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37856,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37856,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37856,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37856,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37856,(5),null);
...
var o__26383__auto__ = f;
return (o__26383__auto__["getBasis"]).call(o__26383__auto__);
});
/**
...
}catch (e37864){var _e__26390__auto__ = e37864;
...
var G__37964 = (obj[cljs.core.first(path)]);
var G__37965 = cljs.core.rest(path);
obj = G__37964;
path = G__37965;
continue;
} else {
...
var _STAR_ = (function (accum,p__37877){
var vec__37878 = p__37877;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37878,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37878,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37881){
var vec__37882 = p__37881;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37882,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37882,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37882,(2),null);
...
var post_process = (function (p__37898){
var vec__37899 = p__37898;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37885_SHARP_){
return (obj[cljs.core.first(p1__37885_SHARP_)]);
}),sorted_matches);
