...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_33290 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_33290(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_33291 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_33291(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_33295 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_33295(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_33296 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_33296(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_33304 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_33304(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_33333 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_33333(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_33344 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_33344(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_33353 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_33353(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_33354 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_33354(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_33357 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_33357(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k33277,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__33282){
var vec__33283 = p__33282;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33283,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33283,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__33276){
var self__ = this;
var G__33276__$1 = this;
return (new cljs.core.RecordIter((0),G__33276__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this33278,other33279){
var self__ = this;
var this33278__$1 = this;
return (((!((other33279 == null)))) && ((this33278__$1.constructor === other33279.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this33278__$1.status,other33279.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this33278__$1.body,other33279.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this33278__$1.status_text,other33279.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this33278__$1.headers,other33279.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this33278__$1.was_aborted,other33279.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this33278__$1.__extmap,other33279.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__33276){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__33286 = cljs.core.keyword_identical_QMARK_;
var expr__33287 = k__4388__auto__;
if(cljs.core.truth_((pred__33286.cljs$core$IFn$_invoke$arity$2 ? pred__33286.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__33287) : pred__33286.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__33287)))){
return (new ajax.protocols.Response(G__33276,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__33286.cljs$core$IFn$_invoke$arity$2 ? pred__33286.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__33287) : pred__33286.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__33287)))){
return (new ajax.protocols.Response(self__.status,G__33276,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__33286.cljs$core$IFn$_invoke$arity$2 ? pred__33286.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__33287) : pred__33286.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__33287)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__33276,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__33286.cljs$core$IFn$_invoke$arity$2 ? pred__33286.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__33287) : pred__33286.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__33287)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__33276,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__33286.cljs$core$IFn$_invoke$arity$2 ? pred__33286.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__33287) : pred__33286.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__33287)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__33276,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__33276),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__33276){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__33276,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__33280){
var extmap__4419__auto__ = (function (){var G__33289 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__33280,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__33280),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__33280),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__33280),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__33280),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__33280),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
