...
var G__30756 = devtools.prefs.pref(v);
v = G__30756;
continue;
} else {
return v;
...
}catch (e30653){var _e__28608__auto__ = e30653;
return false;
}})();
...
}catch (e30668){var _e__28608__auto__ = e30668;
return false;
}})();
...
}catch (e30680){var _e__28608__auto__ = e30680;
return false;
}}
}
});
...
var vec__30702 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30702,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30702,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30748_SHARP_);
}),template);
});
