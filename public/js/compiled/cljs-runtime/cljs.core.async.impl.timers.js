...
var i_32503 = (0);
while(true){
if((i_32503 < arr.length)){
(arr[i_32503] = null);

var G__32506 = (i_32503 + (1));
i_32503 = G__32506;
continue;
} else {
}
...
var i_32526 = (self__.level + (1));
while(true){
if((i_32526 <= (new_level + (1)))){
(update[i_32526] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32530 = (update[i]).forward;
(x__$2.forward[i] = (links_32530[i]));
...
var i_32542 = (0);
while(true){
if((i_32542 <= self__.level)){
var links_32545 = (update[i_32542]).forward;
if((x__$1 === (((i_32542 < links_32545.length))?(links_32545[i_32542]):null))){
(links_32545[i_32542] = (x__$1.forward[i_32542]));

var G__32548 = (i_32542 + (1));
i_32542 = G__32548;
continue;
} else {
var G__32549 = (i_32542 + (1));
i_32542 = G__32549;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__32579 = nx;
var G__32580 = (level__$1 - (1));
x = G__32579;
level__$1 = G__32580;
continue;
} else {
var G__32581 = x;
var G__32582 = (level__$1 - (1));
x = G__32581;
level__$1 = G__32582;
continue;
}
