...
random_quote.core.app_state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"text","text",-1790561697),"Welcome to my Random Quote Generator",new cljs.core.Keyword(null,"author","author",2111686192),"by Cesar Roberto"], null));
}
random_quote.core.fetch_link_BANG_ = (function random_quote$core$fetch_link_BANG_(state){
return ajax.core.GET.cljs$core$IFn$_invoke$arity$variadic("https://quote-garden.herokuapp.com/api/v3/quotes/random",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (data){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"text","text",-1790561697),cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(data,"data"),(0)),"quoteText"));

return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"author","author",2111686192),cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(data,"data"),(0)),"quoteAuthor"));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p__29533){
...
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29534__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29534__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var G__29537 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [random_quote.core.quote,random_quote.core.app_state], null);
var G__29538 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__29537,G__29538) : reagent.core.render_component.call(null,G__29537,G__29538));
});
