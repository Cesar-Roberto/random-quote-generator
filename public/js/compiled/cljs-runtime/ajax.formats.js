...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__33542){
...
var request = map__33543__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33543__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__33547 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__33547.cljs$core$IFn$_invoke$arity$1 ? fexpr__33547.cljs$core$IFn$_invoke$arity$1(response) : fexpr__33547.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__33548 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__33548.cljs$core$IFn$_invoke$arity$1 ? fexpr__33548.cljs$core$IFn$_invoke$arity$1(response) : fexpr__33548.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__33549){
...
var request = map__33550__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33550__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
